...
#Inferenceinput#inputrch.randn(1, 64000)
...
# model = model.module if isinstance(model, nn.DataParallel) else modelodel
...
#with tjit.orch.inference_mod# e():    #print(model(input))
